...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="flex bg-[var(--light-primary)] w-full h-screen overflow-hidden items-center justify-center">
        <div class="h-fit gap-4 px-8 py-4 max-w-sm w-3/5 flex flex-col bg-white">
            ...
            <span class="text-center text-[var(--light-secondary)]">Already have an account? <a class="text-[var(--primary)] hover:underline" href="/Views/Auth/Login.aspx">Login Here</a></span>
        </div>
    </div>
</asp:Content>
