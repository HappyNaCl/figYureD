...
namespace figYureD.Views.Admin
{
    public partial class AdminTransaction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblTotal.Text = "Rp. " + totalSale.ToString();
        }

        private void BindTransactions()
        {
            List<TransactionHeader> headers = controller.GetAllTransactions();
            List<HeaderViewModel> headerModels = new List<HeaderViewModel>();

            foreach (TransactionHeader header in headers)
            {
                HeaderViewModel headerViewModel = new HeaderViewModel();
                headerViewModel.CustomerName = userController.GetUser(header.UserId).Username;
                ...
                foreach (TransactionDetail detail in details)
                {
                    ...
                    totalSale += headerViewModel.Total;
